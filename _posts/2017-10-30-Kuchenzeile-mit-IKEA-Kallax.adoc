...
![Normal image](//images/kitchen_IKEA/Installation_fertig_1.jpg)
...
![Normal image](https://github.com/cmolitor/blog/tree/gh-pages/images/kitchen_IKEA/Befestigung_Bein.jpg)
